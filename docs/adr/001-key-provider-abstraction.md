...
**Status:** Accepted (extension) — **security properties RE-AUDITED 2026-06-23** (both runtime-verified; see [Security-relevant properties](#security-relevant-properties--re-audited-2026-06-23) below). One divergence found and deferred: `migrate --to passphrase` is unimplemented (#122).
**Date:** 2026-06-12
