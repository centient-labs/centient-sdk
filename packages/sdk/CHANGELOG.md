...
- e3f6bd3: Add `client.evidence` — a typed `EvidenceResource` for engram-server's append-only evidence series (ADR-042 D3 / engram-server #1035; requires engram-server >= 0.47.0). Issue #156.
